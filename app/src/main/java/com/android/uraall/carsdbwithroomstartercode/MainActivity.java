...
import Data.CarsDatabase;
import Model.Car;

public class MainActivity extends AppCompatActivity {

    private CarsAdapter carsAdapter;
    private ArrayList<Car> carsArr = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carsDatabase = Room.databaseBuilder(getApplicationContext(), CarsDatabase.class,
                "CarsDB").allowMainThreadQueries().build();

        new GetAllCarsAsyncTask().execute();

        carsAdapter = new CarsAdapter(this, carsArr, MainActivity.this);
    ...
    private class GetAllCarsAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            carsArr.addAll(carsDatabase.getCarDAO().getAllCars());
    ...
    private class CreateCarAsyncTask extends AsyncTask<Car, Void, Void> {
        ...
        protected Void doInBackground(Car... cars) {
            long id = carsDatabase.getCarDAO().addCar(cars[0]);
            
            Car car = carsDatabase.getCarDAO().getCar(id);
    ...
    private class UpdateCarAsyncTask extends AsyncTask<Car, Void, Void> {
        ...
        protected Void doInBackground(Car... cars) {
            ...
            carsDatabase.getCarDAO().updateCar(cars[0]);
    ...
    private class DeleteCarAsyncTask extends AsyncTask<Car, Void, Void> {
        ...
        protected Void doInBackground(Car... cars) {
            ...
            carsDatabase.getCarDAO().deleteCar(cars[0]);
            return null;
        }
